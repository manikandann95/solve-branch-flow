    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center glass rounded-2xl p-10">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          That branch doesn't exist in the tree.
        </p>
        <Link
          to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TroubleshootFlow — IT Decision Tree Builder" },
      { name: "description", content: "Build, share, and walk through interactive IT troubleshooting decision trees for Windows 11, Azure Entra, Windows Server, and Active Directory." },
      { property: "og:title", content: "TroubleshootFlow" },
      { property: "og:description", content: "Interactive IT troubleshooting decision tree builder for L1/L2 support engineers." },
